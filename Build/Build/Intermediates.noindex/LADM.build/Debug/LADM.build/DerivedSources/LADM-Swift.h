...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LADM",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC4LADM11AppDelegate")
...
- (IBAction)showSettingsWindow:(id _Nullable)sender;
...
- (void)receivedShutdownNotification:(NSNotification * _Nonnull)note;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@interface AppDelegate (SWIFT_EXTENSION(LADM)) <NSWindowDelegate>
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
@end

@class SUUpdater;
@class SUAppcastItem;
@interface AppDelegate (SWIFT_EXTENSION(LADM)) <SUUpdaterDelegate>
- (void)updaterWillRelaunchApplication:(SUUpdater * _Nonnull)updater;
- (void)updater:(SUUpdater * _Nonnull)updater didCancelInstallUpdateOnQuit:(SUAppcastItem * _Nonnull)item;
@end
