                ...
                VStack(alignment: .leading, spacing: 2) {
                    ...
                    HStack(alignment: .firstTextBaseline) {
                        ...
                        if isEditingAmbientLightLevelManually {
                            // onCommit: was deprecated in newer SwiftUI.
                            // The modern replacement is .onSubmit { } — like pressing
                            // Enter on a keyboard to confirm a form field.
                            TextField("", text: $editingAmbientLightManuallyTextFieldStore)
                                .onSubmit {
